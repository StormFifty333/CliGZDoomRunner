...
MKLINK "%DESKTOP%\GZDoom Runner.lnk" "%localappdata%\GZDoom\gzdoomrunner.bat"

MKDIR "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\GZDoom Runner"
MKLINK "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\GZDoom Runner" "%localappdata%\GZDoom\gzdoomrunner.bat"